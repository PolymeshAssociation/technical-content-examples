...
export default function Home() {
  ...
  async function getCustomerInfo(): Promise<Response> {
    ...
    if (response.status == 404) {
      setStatus(
        "Customer not found, reload the page and enter your information"
      );
  ...
  async function submitValid(
    ...
    await sendValidInfo(
      (e.target as HTMLButtonElement).getAttribute("data-valid") === "true"
    );
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>EzKyc Management Tool</h1>
        ...
        <form lang="en">
          <fieldset className={styles.card}>
            ...
            <div className="submit">
              <button
                className="submit customerId"
                onClick={submitGetCustomerInfo}
              >
                Fetch their info
              </button>
            </div>
          ...
          <fieldset className={styles.card}>
            ...
            <div>
              After careful review of the documents, we have decided to:
            </div>
