...
import { ClaimData, ClaimType, CountryCode, Identity, ScopeType } from "@polymathnetwork/polymesh-sdk/types"
...
describe("ClaimForwarderPoly Integration Tests", () => {
    ...
    it("getJurisdictionClaim throws if more than 1 identity returned", async () => {
        const claimForwarder: ClaimForwarderPoly = new ClaimForwarderPoly(api)
        const alice: Identity = await api.getCurrentIdentity()
