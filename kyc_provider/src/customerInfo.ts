import { CountryCode } from "@polymeshassociation/polymesh-sdk/generated/types";
...
export class CustomerInfo implements ICustomerInfo {
  ...
  constructor(info: JSON) {
    ...
    if (
      typeof info["polymeshDid"] !== "undefined" &&
  ...
  patch(extra: JSON): void {
    this.name =
      typeof extra["name"] !== "undefined" ? extra["name"] : this.name;
    if (
      typeof extra["country"] !== "undefined" &&
      !Object.values(CountryCode).includes(extra["country"])
    ) {
      throw new InvalidCountryCodeError(extra["country"]);
    }
    this.country =
      typeof extra["country"] !== "undefined"
        ? CountryCode[extra["country"]]
        : this.country;
    this.passport =
      typeof extra["passport"] !== "undefined"
        ? extra["passport"]
        : this.passport;
    this.valid =
      typeof extra["valid"] !== "undefined" ? extra["valid"] : this.valid;
    if (
      typeof extra["jurisdiction"] !== "undefined" &&
      !Object.values(CountryCode).includes(extra["jurisdiction"])
    ) {
      throw new InvalidCountryCodeError(extra["jurisdiction"]);
    }
    this.jurisdiction =
      typeof extra["jurisdiction"] !== "undefined"
        ? CountryCode[extra["jurisdiction"]]
        : this.jurisdiction;
    if (
      typeof extra["polymeshDid"] !== "undefined" &&
